...
const dataParrafos = require("./data/05_DataParrafo.json");
...
describe('Prueba la pagina ghost', () => {
    ...
    it('Enlazar con facebook', () => {
        ...
        variableTitulo = dataPrueba[getRandomArbitrary(1, 10)].login;
        variableParrafo = variableParrafo.concat(dataParrafos[getRandomArbitrary(1, 10)].parrafo, ' ');
        variableParrafo = variableParrafo.concat(dataParrafos[getRandomArbitrary(1, 10)].parrafo, ' ');
        variableParrafo = variableParrafo.concat(dataParrafos[getRandomArbitrary(1, 10)].parrafo, ' ');
        variableParrafo = variableParrafo.concat(dataParrafos[getRandomArbitrary(1, 10)].parrafo, ' ');
        variableParrafo = variableParrafo.concat(dataParrafos[getRandomArbitrary(1, 10)].parrafo, ' ');
